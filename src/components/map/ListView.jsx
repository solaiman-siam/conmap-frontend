    ...
    <div className="bg-white xl:w-[800px] md:p-8 rounded-2xl">
      ...
      <div className="mb-5 pt-4 px-4">
        ...
        <p className="md:text-lg lg:text-xl font-medium">
          To sort your search results click on one of the column headings
          below.
        </p>
      </div>
      <div className="pb-4">
        <DataTable listView={listView} />
      </div>
    </div>
  </div>
  )
